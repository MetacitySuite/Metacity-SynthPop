...
"""
MATSim XML writers from
https://github.com/eqasim-org/sao_paulo/blob/master/matsim/writers.py
"""
...
class PopulationWriter(XmlWriter):
    ...
    def add_leg(self, mode, departure_time = np.nan, travel_time = np.nan):
        self._require_scope(self.PLAN_SCOPE)
