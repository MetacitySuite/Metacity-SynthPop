...
def execute(context):
    ...
    df_unemployed = df_census_matched[~df_census_matched.person_id.isin(df_employed.person_id.values)]
    df_u = df_unemployed[~df_unemployed.person_id.isin(df_students.person_id.values)]
